                  ...
                  <div class="col-lg-12">
                      ...
                      <ValidationProvider v-slot="{ errors }" name="card" rules="required">
                        <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9">
                            <input type="text" id="text-input" name="text-input" v-model="form.card_id" class="form-control" />
                        ...
                        <div class="row form-group">
                          <div class="col col-md-3">
                            <label for="email-input" class="form-control-label"
                              >เลขประจำตัวนักเรียน :</label
                            >
                          </div>
                          <div class="col-12 col-md-9">
                            <input type="text" v-model="form.student_id" id="id_student" name="id_student" class="form-control"/>
                   ...
                   <div class="row form-group">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                          ...
                          >
                            ...
                            <option value="7">
                              บุคคลที่มีปัญหาทางพฤติกรรมหรืออารมณ์
                            </option>
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col col-md-2">
                          <label for="selectSm" class="form-control-label"
                            >ชั้นที่เข้าเรียน</label
                          >
                        </div>
                        <div class="col-12 col-md-2">
                          <select
                            name="select"
                            v-model="form.stu_chun"
                            id="select"
                            class="form-control form-control"
                          >
                            <option :value="null">กรุณาเลือก</option>
                        ...
                        <div class="col col-md-2">
                          <label for="selectSm" class="form-control-label"
                            >ห้องที่เข้าเรียน</label
                          >
                        </div>
                        <div class="col-12 col-md-2">
                          <select
                            name="select"
                            v-model="form.stu_room"
                            id="select"
                            class="form-control form-control"
                          >
                            <option :value="null">กรุณาเลือก</option>
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-12 col-md-2">
                          ...
                          >
                            ...
                            <option
                              :value="teachers.id"
                              v-for="(teachers, index) in teacher"
                              :key="index"
                            >
                              {{ teachers.teacher.teacher_name }}
                              {{ teachers.teacher.teacher_lname }}
                            </option>
                          </select>
                        </div>
                      </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-3"><input type="text" v-model="form.address_number_band1" id="email-input" name="email-input" class="form-control"><small class="help-block form-text"></small></div>
                                            <div class="col col-md-3"><label for="password-input" class=" form-control-label">เลขที่บ้าน :</label></div>
                                            <div class="col-12 col-md-3"><input type="text" v-model="form.address_number_band2" id="password-input" name="password-input" class="form-control"><small class="help-block form-text"></small></div>
                                        </div>
...
export default {
  ...
  methods: {
    async submit() {
      ...
      axios
        .post("/submiteditstudent", this.form)
        .then((res) => {
          if (res.status == 200) {
