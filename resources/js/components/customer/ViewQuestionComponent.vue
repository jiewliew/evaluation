    ...
    <div class="modal-dialog-1 modal-full" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">ผลการทดสอบ-</h5>
            ...
            >
              ...
              <div slot="action" slot-scope="props">
                <p v-if="props.rowData.action=='ผ่าน'">
                    <font color ="green">{{props.rowData.action}}</font></p>
                <p v-if="props.rowData.action=='ไม่ผ่าน'">
                    <font color ="red">{{props.rowData.action}}</font></p>
              </div>
            </vuetable>
...
export default {
 ...
 async mounted() {
  ...
  computed: {
    ...mapGetters({
      data: "registerorder/dataquestion",
  ...
  methods: {
    ...
    changedata(event) {
      ...
      this.$store.dispatch("registerorder/getorder", data);
    },
    trick(data) {
      let getData = {};
